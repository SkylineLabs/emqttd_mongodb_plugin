...
-module(emqttd_mongodb_plugin_app).
...
stop(_State) ->
    ok = emqttd_access_control:unregister_mod(auth, emq_auth_emqttd_mongodb_plugin),
    ok = emqttd_access_control:unregister_mod(acl, emq_acl_emqttd_mongodb_plugin),
    emqttd_mongodb_plugin:unload().
